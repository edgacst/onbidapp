...
function App() {
  ...
  async function submitAuth(event) {
    ...
    try {
      ...
      pushAppHistory(record.role === "admin" ? "admin" : "mypage");
      setView(record.role === "admin" ? "admin" : "mypage");
      const visitCount = Number(record.loginCount || 1);
        ...
        {view === "home" ? (
          ...
          <section className="legal-page">
            <section className="legal-card">
              ...
              <h3>8. 개인정보 보호책임자</h3>
              <p>개인정보 보호책임자는 김기철이며, 개인정보 열람·정정·삭제·처리정지 요청 및 관련 문의는 freecompr@naver.com 으로 접수할 수 있습니다.</p>
            </section>
          </section>
        ) : view === "terms" ? (
          <section className="legal-page">
            <section className="legal-card">
              ...
              <h3>9. 고객지원</h3>
              <p>서비스 이용 문의는 freecompr@naver.com 으로 접수할 수 있습니다.</p>
            </section>
          </section>
        ) : view === "admin" ? (
